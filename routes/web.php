...
Route::group(['prefix' => 'employees', 'as' => 'employees.'],function (){
    ...
    Route::delete('index/{id}',[EmployeeController::class,'destroy'])->name('destroy');
...
Route::group(['namespace' => '\LaraSnap\LaravelAdmin\Controllers','prefix' => 'admin', 'middleware' => ['web', 'auth', 'check-userstatus'], 'roles' => '' ], function(){
    ...
    Route::group(['middleware' => ['check-roles'] ], function(){
        ...
        /** SETTING ROUTES **/
        //Route::get('products/index','CategoryController@index')->name('products.index');
        Route::group(['prefix' => 'products', 'exculde' => ['products.store']], function(){
            Route::get('/index','ProductController@index')->name('products.index');
            Route::get('/','ProductController@create')->name('products.create');
